...
export const TeacherSidebar = ({ currentView, setCurrentView }: TeacherSidebarProps) => {
  const menuItems = [
    { id: "dashboard", label: "Dashboard", icon: LayoutDashboard },
    { id: "students", label: "Students Data", icon: Users },
    { id: "assignments", label: "Assignments", icon: FileText },
    { id: "analytics", label: "Analytics", icon: BarChart3 },
    { id: "training", label: "Teacher Training", icon: GraduationCap },
      ...
      <div className="p-6 border-b border-white/10">
        ...
        <div className="flex flex-col items-center space-y-3">
          ...
          <div className="text-center">
            <h2 className="text-lg font-semibold text-white">Prof. Aman</h2>
            <p className="text-sm text-white/70">ak88xxxx@gmail.com</p>
          </div>
        </div>
      </div>
